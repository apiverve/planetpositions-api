...
```java
import com.apiverve.planetpositions.PlanetPositionsAPIClient;
import com.apiverve.planetpositions.APIResponse;
import com.apiverve.planetpositions.APIException;

// Initialize the client
PlanetPositionsAPIClient client = new PlanetPositionsAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/planetpositions](https://docs.apiverve.com/ref/planetpositions)
...
- **Documentation:** [https://docs.apiverve.com/ref/planetpositions](https://docs.apiverve.com/ref/planetpositions)
- **Issues:** [GitHub Issues](https://github.com/apiverve/planetpositions-api/issues)
