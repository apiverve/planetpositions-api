# Planet Positions API - Examples

This folder contains example code for using the Planet Positions API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/planetpositions',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/planetpositions");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/planetpositions](https://docs.apiverve.com/ref/planetpositions)
