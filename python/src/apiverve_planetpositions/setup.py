...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/planetpositions',
        'Source': 'https://github.com/apiverve/planetpositions-api',
        'Bug Tracker': 'https://github.com/apiverve/planetpositions-api/issues'
    },
    classifiers=[
