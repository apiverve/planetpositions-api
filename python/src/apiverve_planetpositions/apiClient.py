...
class PlanetpositionsAPIClient:
    ...
    VALIDATION_RULES = {
        ...
        "alt": {"type": "number", "required": False, "min": 0, "default": 0},
    ...
    def execute(self, params: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:  # Returns PlanetPositionsData in 'data' field
        """
